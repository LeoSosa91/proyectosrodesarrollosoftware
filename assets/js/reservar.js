$(document).ready(function () {
    ...
    $("#idTurnoRes").change(function () {
        ...
        hora.innerHTML = '<option value="0">Seleccione un horario...</option>'
    ...
    $("#btnConsultar").click(function () {
        ...
        var mgsAlert = "";
        if (cantPers == "0" || turno == "0" || hora == "0"||fecha=="") {
            mensajeConsulta.innerHTML = '<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>No puede realizar la consulta de reserva dado que hay al menos un campo sin completar</strong><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
        } else {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == false) {
                        ...
                        if (res.statusMesaEncontrada == false) {
                            ...
                            document.getElementById('selectCantPers').disabled = true;
                            document.getElementById('inputFecha').disabled = true;
                            document.getElementById('idTurnoRes').disabled = true;
