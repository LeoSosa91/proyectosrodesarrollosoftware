              ...
              <div class="tab-content">
                ...
                ?>" id="home" role="tabpanel">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url(route_to('guardarInfoPersonal'))?>" method="post" class="p-4">
                                <div class="row">
                ...
                <div class="tab-pane <?php if (session('errors.inputConfirmPasswordNew')||session('errors.inputPasswordNew')) {echo'active';}?>" id="profile" role="tabpanel">
                  <div class="card">
										<div class="card-body">
											<h5 class="card-title">Password</h5>

											<form action="<?=base_url(route_to('guardarPassword'))?>" method="post" class="p-4">
                        <input type="hidden" name="idUser" id="idUser" value="<?=$user['id_user'];?>">
                        <div class="mb-3">
